//Esse codg foi criado pelo Peter Knight em 2011
// Em 11/08/2021 Victor e AcaciaCalegari comecaram adaptar esse cdg, q eh lancado sob licenca GPLv2
// Usamos o pin3 do arduino para fzr a coneccao da cx d som, mas tb pd ser feito usando um amplificador, usamos um jump jacare conectado direto no fone
// esse talkie.h eh uma biblioteca d voz do arduino
// uint8_t eh um sinal d 8bits , tipo igual a gnt declara em python as variaveis como int, float, char... esse uint8_t eh como se fosse uma mistura de char cm int

#include "talkie.h"

Talkie voice; //cada uint8_t desse eh um som != (diferent),alguns sao trechos d musicas
